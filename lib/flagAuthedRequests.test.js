...
describe('lib/flagAuthedRequests', () => {
  ...
  test('email should be accepted in query instead of body', () => {
    /* We need to accommodate GETs. An authenticated user might not have
       the type of game-name cookie that non-authenticated requests expect.
       
       This needs to be considered in thinking about when the game name cookie
       check middleware is called.
    */
